...
public class SeleniumAppliToolsVisualGridRunnerTest {
	...
	public static void ultraFastTest(WebDriver webDriver, Eyes eyes) {
		...
		try {
			...
			webDriver.get("https://sites.google.com/view/helpcenter24x7/home");
			...
			eyes.check("test",Target.window().fully(true));

			/*eyes.check("Check By Loctor", Target.region(By.id("log-in")));

			// this is equivalent to
 
			eyes.check("Check By Region", Target.region(new Region(166, 185, 458, 409)));
